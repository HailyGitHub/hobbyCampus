	...
	<main class="main-area">
		...
		<article class="select-list m-5">
			<div class="d-grid gap-2 d-md-block col-md-12 text-center">
				<button class="btn btn-primary btn-lg" type="button" id="btn_1"><i class="bi bi-mortarboard-fill"></i> 학생계정</button>
							...
							<tr>
								...
								<td>
									<div class="form-check form-switch">
										<input class="form-check-input" type="checkbox" role="switch" onclick="return switchActive(${dto.u_idx})" id="${dto.u_idx}" data-state="${dto.u_state}" ${dto.u_state=='활성'? 'checked':''}${dto.u_state=='탈퇴'? 'disabled':''}>
